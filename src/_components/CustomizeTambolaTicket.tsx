...
const CustomizeTambolaTicket = ({ setTicketStyle, setHostName, hostName, ticketStyle }: ICustomizeTambolaTicket) => {
    ...
    return (
        <div className="flex flex-row justify-between" >
            <div className="printme">
                <TabolaTicketTemplate ticketNumbers={[
                    89, 95, 0, 99, 0, 55, 79, 0,
                    0, 0, 1, 0, 9, 0, 65, 83,
                    90, 0, 36, 0, 73, 31, 0, 57,
                    0, 21, 0
                ]} hostName={hostName} ticketStyle={ticketStyle} ticketId={"sampleTicket"} code={"1234"} />
            </div>
            <div className="pl-[300px] w-screen flex flex-col justify-between">
                ...
                <Input
                    ...
                    type='color'
                />
                <Button onClick={() => handleDownloadImage("sampleTicket")}>Download Sample</Button>
            </div>
        </div>
    );
};
